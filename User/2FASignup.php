...
$link = \Sonata\GoogleAuthenticator\GoogleQrUrl::generate('Group37', $secret, 'Advanced-IT-Security-project');
echo 'link is \n';
echo $link;
...
<body>
    ...
    <div class="content-2fa">
        <form method="post" action="2FASignup.php">
            <div>
                sign up Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quos numquam dolorem cumque reiciendis! Reprehenderit est minima delectus porro, quod sit, quidem laborum mollitia eligendi earum, nisi esse ut officiis. Mollitia!
            </div>
            <div class='form'>
